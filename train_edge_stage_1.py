...
def main(cfg):
    ...
    pose_weight = torch.load('exp_output/stage1/pose_guider-4000.pth', map_location='cpu')
    denoising_weight = torch.load('exp_output/stage1/denoising_unet-4000.pth', map_location='cpu')
    reference_weight = torch.load('exp_output/stage1/reference_unet-4000.pth', map_location='cpu')
